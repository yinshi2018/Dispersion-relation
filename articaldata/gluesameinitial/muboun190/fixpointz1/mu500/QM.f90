program QM
  ...
  real(8) rho0,mPion,mSigma,mf,Vtotal,fpi,h,dr1dh,dr2dh,dr3dh,dr4dh,dr5dh,Zphi,Zpsi,c
...
!    do i=0, iTmax
    ...
    do i=0, iT
      ...
      call selfEQ(kappa_UV_i,l_i,lb_i,kappa_UV,l,lb,rho0,mPion,mSigma,mf,Vtotal,fpi,h,dr1dh,dr2dh,dr3dh,dr4dh,dr5dh,Zphi,Zpsi,c,&
                      kappa)
      kappa_UV_i=kappa_UV
      l_i=l
      lb_i=lb
