program QM
  ...
  real(8) rho0,mPion,mSigma,mf,Vtotal,fpi,h,dr1dh,dr2dh,dr3dh,dr4dh,dr5dh,Zphil,Zphit,Zpsi,c
  real(8) sigma_UV,kappa_UV_i,kappa_UV_i_mu,kappa_UV,kappa
  real(8) Vtotal0
...
!order of chebyshev polynomial
  ...
  mu_bound_low=190./hc                !fm**(-1)
  mu_bound_high=190./hc                !fm**(-1)
...
!    do i=0, iTmax
    ...
    do i=0, iT
      ...
      call selfEQ(kappa_UV_i,l_i,lb_i,kappa_UV,l,lb,rho0,mPion,mSigma,mf,Vtotal,fpi,h,dr1dh,dr2dh,dr3dh,dr4dh,dr5dh,&
...
!  goto 210
        ...
        open(unit=51,file='./buffer/dr1dh.dat',position='append')
        write(51, "(e21.14)")dr1dh
        close(51)

        open(unit=51,file='./buffer/dr2dh.dat',position='append')
        write(51, "(e21.14)")dr2dh
        close(51)

        open(unit=51,file='./buffer/Zphit.dat',position='append')
        write(51, "(e21.14)")Zphit
        close(51)
