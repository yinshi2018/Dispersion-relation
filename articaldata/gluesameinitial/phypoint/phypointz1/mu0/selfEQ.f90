...
!Inputing guess kappa_UV_i,l_i,lb_i, outputing kappa_UV,l,lb and other physical variables
  ...
  real(8) rho0,mPion,mSigma,mf,Vtotal,fpi,h,Zphi,Zpsi,c,kappa,dr1dh,dr2dh,dr3dh,dr4dh,dr5dh
  ...
  real(8) kk,lam1k,lam2k,lam3k,lam4k,lam5k,lam0k,hk,dr1dhk,dr2dhk,dr3dhk,dr4dhk,dr5dhk,Zphik,Zpsik,ck,kappak,etaphik,etapsik
  ...
  common /y1w1/ y1, w1
  common /y2w2/ y2, w2
  common /flowconfi/ kA,lam1A,lam2A,lam3A,lam4A,lam5A,lam0A,hA,dr1dhA,dr2dhA,dr3dhA,dr4dhA,dr5dhA,ZphiA,ZpsiA,cA,&
                     kappaA,etaphiA,etapsiA
  ...
  do while((.not. stopp).and.(j < jmax))
    ...
    call FRG(kappa_UV_i,kappa_UV,rho0,mPion,mSigma,mf,Vall,fpi,h,dr1dh,dr2dh,dr3dh,dr4dh,dr5dh,Zphi,Zpsi,c,kappa)
    rho0k0=rho0
    Zphik0=Zphi
...
!interpolation
    ...
    do ii=1, npoint1
      ...
      call eta(kk,lam1k,lam2k,lam3k,lam4k,lam5k,lam0k,hk,dr1dhk,dr2dhk,dr3dhk,dr4dhk,dr5dhk,Zphik,Zpsik,ck,kappak,etaphik,etapsik)
