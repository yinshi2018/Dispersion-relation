subroutine dtVdiff1(kk,lam0k,hk,dr1dhk,dr2dhk,dr3dhk,dr4dhk,dr5dhk,         &
                      Zphilk,Zphitk,Zpsik,ck,kappak,etaphilk,etaphitk,etapsik,rhok,l,lb,dtVd1l,dtVd1lb)
!This subroutine calculate various differential kernal corresponding 0<k<k_UV

  implicit none

  integer hrho
  real(8) kk,lam1k,lam2k,lam3k,lam4k,lam5k,lam0k,hk,Zphilk,Zphitk,Zpsik,ck,kappak,etaphilk,etapsik,rhok,dr1dhk,dr2dhk,&
             dr3dhk,dr4dhk,dr5dhk,etaphitk
  real(8) l,lb,l_con,lb_con
  real(8) k,lam1,lam2,lam3,lam4,lam5,lam0,h,Zphil,Zphit,Zpsi,c,kappa,etaphil,etaphit,etapsi,rho,dr1dh,dr2dh,dr3dh,dr4dh,dr5dh
  real(8) mf2
  real(8) T,mu
  real(8) xff,xfa
