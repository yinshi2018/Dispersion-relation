subroutine FRG(kappa_UV_i,kappa_UV,rho0,mPion,mSigma,mf,Vall,fpi,h,dr1dh,dr2dh,dr3dh,dr4dh,dr5dh,Zphi,Zpsi,c,kappa)
...
!dependent variables in flow equations
  ...
  real(8) fpi,h,Zphi,Zpsi,c,kappa,dr1dh,dr2dh,dr3dh,dr4dh,dr5dh
  integer i
  integer iT,iv
  real(8) l_com,lb_com
