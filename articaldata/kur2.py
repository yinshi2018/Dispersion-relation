...
# Data for plotting
p1chi2=np.loadtxt(r'gluesameinitial/fixpointz1/mu460/buffer/chi2.dat')
p1chi4=np.loadtxt(r'gluesameinitial/fixpointz1/mu460/buffer/chi4.dat')
p2chi2=np.loadtxt(r'gluesameinitial/fixpointzneq1/mu460/buffer/chi2.dat')
p2chi4=np.loadtxt(r'gluesameinitial/fixpointzneq1/mu460/buffer/chi4.dat')
p1r42=p1chi4 / p1chi2
p2r42=p2chi4 / p2chi2
...
plt.text(165,1.5,r'$\mu_B=460MeV$')
