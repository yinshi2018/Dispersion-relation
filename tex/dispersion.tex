...
\caption{Fluctuations of the baryon number, $\chi_n^B$'s, up to the fourth order, as functions of the temperature with  $\mu_B=400$ MeV. In the same way, the two cases, $Z_{\phi,k}^{\perp}\ne Z_{\phi,k}^{\parallel}$ and $Z_{\phi,k}^{\perp}=Z_{\phi,k}^{\parallel}$, are compared. Calculations are performed with the approach of the fixed point expansion.}\label{fig:fpi-expan}
\end{figure*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
